...
type fhirpathListener interface {
	...
	// EnterEntireExpression is called when entering the entireExpression production.
	EnterEntireExpression(c *EntireExpressionContext)
	...
	// EnterLongNumberLiteral is called when entering the longNumberLiteral production.
	EnterLongNumberLiteral(c *LongNumberLiteralContext)
	...
	// ExitEntireExpression is called when exiting the entireExpression production.
	ExitEntireExpression(c *EntireExpressionContext)
	...
	// ExitLongNumberLiteral is called when exiting the longNumberLiteral production.
	ExitLongNumberLiteral(c *LongNumberLiteralContext)
