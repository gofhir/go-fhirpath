...
// EnterEntireExpression is called when production entireExpression is entered.
func (s *BasefhirpathListener) EnterEntireExpression(ctx *EntireExpressionContext) {}

// ExitEntireExpression is called when production entireExpression is exited.
func (s *BasefhirpathListener) ExitEntireExpression(ctx *EntireExpressionContext) {}
...
// EnterLongNumberLiteral is called when production longNumberLiteral is entered.
func (s *BasefhirpathListener) EnterLongNumberLiteral(ctx *LongNumberLiteralContext) {}

// ExitLongNumberLiteral is called when production longNumberLiteral is exited.
func (s *BasefhirpathListener) ExitLongNumberLiteral(ctx *LongNumberLiteralContext) {}
